...
#define AUDIO_OUTPUT_FLAG_LIST_DEF(V) \
    ...
    V(OUTPUT_FLAG_PRIMARY, 0x40000) \
    V(OUTPUT_FLAG_HDMI, 0x80000) \
    V(OUTPUT_FLAG_SPDIF, 0x100000) \
    V(OUTPUT_FLAG_HDMI_1, 0x200000) \
    V(OUTPUT_FLAG_SPDIF_1, 0x400000)
...
#define AUDIO_SOURCE_LIST_NO_SYS_DEF(V) \
    ...
    V(AUDIO_SOURCE_HDMIIN, 11) \
    V(AUDIO_SOURCE_HDMIIN_1, 12) \
